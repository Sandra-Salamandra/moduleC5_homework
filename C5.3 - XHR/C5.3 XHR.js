...
btnNode.addEventListener('click', () => {
  ...
  if (1<= valueInput && valueInput <=10) {
    useRequest(`https://picsum.photos/v2/list/?limit=${valueInput.trim()}`, displayResult);
  }
  else if(isNaN(valueInput)) {
    resultNode.innerHTML = "<p>Нужно ввести число от 1 до 10</p>"
  }  
  else {
